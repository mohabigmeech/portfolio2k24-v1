  ...
  <div id="entrepreneur">
    <section class="about__area pt-110 pb-120 p-relative">
      <div class="about__shape">
        <img class="about__shape-3" src="~/assets/img/shape/shape-2.svg" alt="shape">
        <img class="about__shape-5" src="~/assets/img/shape/shape-1.svg" alt="shape">
        <img class="about__shape-6" src="~/assets/img/shape/shape-3.svg" alt="shape">
      </div>
      <div class="container">
        <div class="row">
            ...
            <div class="about__section-wrapper-6">
              <div class="section__title-wrapper-6 mb-125">
                <h3 class="section__title-6">
                  More than a Developer, an <span class="section__title-6-highlight">Entrepreneur
          ...
          <div class="col-xxl-6 offset-xxl-1 col-xl-5 offset-xl-0 col-lg-5 offset-lg-1">
            <div class="section__title-wrapper-6">
              <p>Launching several businesses has shaped my mindset to focus on creating significant impacts for my clients.</p>
            </div>
          </div>
        </div>
        <div class="row">
            ...
            <div class="about__features">
              <div class="about__features-item d-flex align-items-start" data-sal="slide-up" data-sal-delay="130" data-sal-duration="1000">
                ...
                <div class="about__features-content">
                  <h3 class="about__features-title">Building High Value Product</h3>
                  <p>I created 3 Vue.js PWAs from scratch for my businesses, focused on maximum user value.</p>
                </div>
              </div>
              <div class="about__features-item d-flex align-items-start" data-sal="slide-up" data-sal-delay="150" data-sal-duration="1000">
                ...
                <div class="about__features-content">
                  <h3 class="about__features-title">Collaborative Teamwork</h3>
                  <p>Bring together various talents to achieve project goals.</p>
                </div>
              </div>
              <div class="about__features-item d-flex align-items-start" data-sal="slide-up" data-sal-delay="170" data-sal-duration="1000">
                ...
                <div class="about__features-content">
                  <h3 class="about__features-title">Driven by Satisfaction</h3>
                  <p>Ensure customer satisfaction by quickly improving and optimizing features.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="about__video-wrapper" data-sal="slide-up" data-sal-delay="150" data-sal-duration="1000">
              <div class="about__video-counter d-sm-flex align-items-center">
                <div class="about__video-counter-item d-flex align-items-center">
                  <h4><span>4</span></h4>
                  <p>companies <br> launched</p>
                </div>
                <div class="about__video-counter-item d-flex align-items-center">
                  <h4><span>37</span></h4>
                  <p>Github<br> Projects</p>
                </div>
              </div>
              <div class="about__video-thumb">
                <video
                  ...
                  muted
                  autoplay
                  poster="~/assets/img/about/preview.jpg" 
                  Playsinline 
                  preload="auto">
                  <source src="~/assets/img/about/preview.mp4" type="video/mp4">
                  <source src="~/assets/img/about/preview.webm" type="video/webm">
    ...
    <!-- video modal start -->
    <video-modal ref="video_modal" video-url="https://www.youtube.com/embed/Xg4Fbjfo2YI" />
    <!-- video modal end -->
  </div>
</template>
