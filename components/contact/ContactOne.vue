<template>
  <section :class="`contact__area ${el_style? 'pt-110 pb-100' : 'pt-150 pb-150'} p-relative z-index-1`" id="contact">
        ...
        <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-6">
          <div class="contact__wrapper-9">
            <div class="section__title-wrapper-9 mb-85">
              <h3 class="section__title-9">Let's work together 🤝</h3>
            </div>
          </div>
        </div>
          ...
          <div class="contact__list-9 mr-100">
              ...
              >
                ...
                <div class="contact__list-content-9">
                  <h5>Phone Number</h5>
                  <p><a href="tel:+33695307224">+33 6 95 30 72 24</a></p>
                </div>
              </div>
              <div
                class="contact__list-item-9 flex-wrap d-flex align-items-start"
              >
                ...
                <div class="contact__list-content-9">
                  <h5>Email</h5>
                  <p>
                    <a href="mailto:mohamedc.jr@gmail.com">mohamedc.jr@gmail.com</a>
                  </p>
                </div>
              </div>
            </div>
